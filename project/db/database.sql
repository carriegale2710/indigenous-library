...
CREATE TABLE CollectionItem (
    ...
    thumbnailPath  VARCHAR(255) NOT NULL DEFAULT 'uncatalogued-item.webp',
...
(1, 1, 1, 'Kalaw Lagaw Ya Dictionary', 'Torres Strait Language Centre', 2018, 'book', 'A community dictionary of the Kalaw Lagaw Ya language.', 'kalaw-lagaw-ya-dictionary.webp', NULL),
(2, 1, 2, 'Recordings of Meriam Mir Speakers', 'Dr Anne Foster', 2005, 'recording', 'Audio recordings of fluent Meriam Mir speakers.', 'recordings-of-meriam-mir-speakers.webp', '2026-11-15'),
(3, 2, 2, 'Creation Songline of the Seven Sisters', 'Recorded with community Elders', 1998, 'recording', 'A recorded songline shared under cultural protocol.', 'creation-songline-of-the-seven-sisters.webp', '2026-12-01'),
(4, 2, 1, 'Oral History: Mission Days', 'Community History Project', 2010, 'recording', 'Interviews recalling life on the missions.', 'oral-history-mission-days.webp', NULL),
(5, 3, 1, 'Weaving Patterns of the Yolngu', 'Buku-Larrnggay Mulka Centre', 2015, 'image', 'Photographs documenting traditional weaving patterns.', 'weaving-patterns-of-the-yolngu.webp', NULL),
(6, 3, 2, 'Ceremony Photographs Collection', 'Unknown photographer', 1972, 'image', 'A restricted set of ceremony photographs.', 'ceremony-photographs-collection.webp', '2026-09-20'),
(7, 1, 1, 'Children''s Picture Book in Yumplatok', 'Torres Strait Language Centre', 2020, 'book', 'An illustrated children''s book in Yumplatok (Torres Strait Creole).', 'childrens-picture-book-in-yumplatok.webp', NULL),
(8, 2, 2, 'Men''s Business Recordings', 'Recorded with community Elders', 1985, 'recording', 'Restricted recordings held under cultural protocol.', 'mens-business-recordings.webp', '2027-01-10'),
(9, 3, 1, 'Bark Painting Records', 'Arnhem Land Art Project', 2012, 'image', 'Catalogue of bark paintings with artist notes.', 'bark-painting-records.webp', NULL),
(10, 2, 3, 'Restricted Ceremony Audio', 'Recorded with community Elders', 1990, 'recording', 'Ceremony audio with an access request under assessment.', 'restricted-ceremony-audio.webp', '2026-08-05'),
(11, 1, 1, 'Yolngu Matha Language Primer', 'Yirrkala Community School', 2017, 'book', 'An introductory primer for Yolngu Matha.', 'yolngu-matha-language-primer.webp', NULL),
(12, 2, 2, 'Sacred Site Survey Notes', 'Heritage Survey Team', 2003, 'manuscript', 'Field notes referencing restricted sacred sites.', 'sacred-site-survey-notes.webp', '2026-10-30'),
(13, 3, 1, 'Community Festival Photographs', 'Community Media Unit', 2019, 'image', 'Photographs from annual community festivals.', 'community-festival-photographs.webp', NULL),
(14, 2, 3, 'Initiation Recordings', 'Recorded with community Elders', 1988, 'recording', 'Initiation recordings with an access request under assessment.', 'initiation-recordings.webp', '2026-08-05'),
(15, 2, 1, 'Dreaming Stories Anthology', 'Community Storytellers', 2014, 'book', 'A published anthology of Dreaming stories cleared for public access.', 'dreaming-stories-anthology.webp', NULL),
(16, 4, 1, 'Seasonal Plant Knowledge Cards', 'Community Health Project', 2021, 'resource', 'Illustrated cards describing traditional plant uses and seasonal gathering calendars, cleared for public education.', 'seasonal-plant-knowledge-cards.webp', NULL),
(17, 4, 3, 'Healing Practices Recordings', 'Recorded with senior knowledge holders', 1996, 'recording', 'Recordings of healing practices and plant preparation methods shared under specific cultural conditions.', 'healing-practices-recordings.webp', '2026-09-01'),
(18, 5, 1, 'Caring for Sea Country Photo Series', 'Coastal Rangers Program', 2022, 'image', 'Photographs documenting sea country management, ranger programs and community-led conservation work.', 'caring-for-sea-country-photo-series.webp', NULL),
(19, 5, 2, 'Land Management Oral Histories', 'Community History Project', 2009, 'recording', 'Interviews with Elders describing traditional land management and fire practices, access restricted pending family consent.', 'land-management-oral-histories.webp', '2026-10-15'),
(20, 2, 2, 'Recently Donated Community Recordings', 'Donated by community member', 2023, 'recording', 'Newly catalogued recordings awaiting cultural review before an access status is set.', 'recently-donated-community-recordings.webp', NULL);
